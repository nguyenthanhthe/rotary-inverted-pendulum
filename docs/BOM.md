...
**Ước tính chi phí**  
- Tổng chi phí mua bổ sung linh kiện (chưa có sẵn): **khoảng 350.000đ**.
- Tổng chi phí chế tạo mới toàn bộ từ đầu (bao gồm cả các linh kiện đã có sẵn trong danh sách của bạn): **khoảng 500.000đ** (~£15) — rẻ hơn hàng trăm lần so với bộ Quanser QUBE có giá £4,500.
...
| Động cơ bước | Động cơ bước NEMA17 (thân ngắn, dòng định mức ~1 A) | 130.000đ | [lkcg.vn](https://lkcg.vn/) | Thân động cơ ngắn/nhỏ gọn phù hợp với thiết kế của rig. |
| Driver động cơ bước | DRV8825 (hoặc A4988 / TMC2209) | 52.500đ | [lkcg.vn](https://lkcg.vn/) | Đặt Vref thành 0.485 V (tương đương giới hạn dòng điện ≈ 0.9 A, bằng 90% dòng định mức của động cơ). |
...
| Bo mạch lỗ | PCB đục lỗ phíp sợi thủy tinh FR4 - 2 mặt (40x60mm) | 13.000đ | [lkcg.vn](https://lkcg.vn/) | Bo mạch chất lượng cao, hai mặt lỗ mạ thiếc dùng để hàn toàn bộ mạch điện tử. |
...
- Dây nối mạch (khuyên dùng dây lõi đơn AWG để dễ cắm và hàn trên protoboard)
